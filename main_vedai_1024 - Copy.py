...
def update_annotations(filename):
		data = pd.read_csv('annotations1024/' + filename, sep=' ', index_col=None, header=None, names=['x_center', 'y_center', 'orientation', 'class', 'is_contained', 'is_occluded', 'corner1_x', 'corner2_x', 'corner3_x', 'corner4_x', 'corner1_y', 'corner2_y', 'corner3_y', 'corner4_y'])
		...
		for row in range(len(data)):
			...
			try:
				...
				tree.write("image_1024/{0}.xml".format(imagename))
...
if __name__ == '__main__':
	list = os.listdir('annotations1024/')
